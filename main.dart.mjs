...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1319: (x0,x1) => x0.append(x1),
      _1331: (x0,x1) => x0.item(x1),
      _1332: x0 => x0.decode(),
      _1333: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1334: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1337: x0 => x0.send(),
      _1338: () => new XMLHttpRequest(),
      _1339: (x0,x1) => x0.query(x1),
      ...
      _1342: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1343: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      ...
      _1593: (x0,x1) => new WebSocket(x0,x1),
      _1594: (x0,x1) => x0.send(x1),
      _1595: (x0,x1,x2) => x0.close(x1,x2),
      _1596: (x0,x1) => x0.close(x1),
      _1597: x0 => x0.close(),
      _1598: (x0,x1) => x0.appendChild(x1),
      _1607: x0 => new BroadcastChannel(x0),
      _1608: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1608(f,arguments.length,x0) }),
      _1609: (x0,x1) => x0.postMessage(x1),
      _1610: x0 => x0.close(),
      _1611: () => new AbortController(),
      _1612: x0 => x0.abort(),
      _1613: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1614: (x0,x1) => globalThis.fetch(x0,x1),
      _1615: (x0,x1) => x0.get(x1),
      _1616: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1616(f,arguments.length,x0,x1,x2) }),
      _1617: (x0,x1) => x0.forEach(x1),
      _1618: x0 => x0.getReader(),
      _1619: x0 => x0.cancel(),
      _1620: x0 => x0.read(),
      _1621: x0 => x0.trustedTypes,
      _1622: (x0,x1) => { x0.src = x1 },
      _1623: (x0,x1) => x0.createScriptURL(x1),
      _1624: x0 => x0.nonce,
      _1625: (x0,x1) => x0.debug(x1),
      _1626: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1626(f,arguments.length,x0) }),
      _1627: x0 => ({createScriptURL: x0}),
      _1628: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1629: (x0,x1) => x0.querySelectorAll(x1),
      _1630: (x0,x1) => x0.key(x1),
      _1632: o => o instanceof Array,
      _1637: a => a.pop(),
      _1638: (a, i) => a.splice(i, 1),
      _1640: (a, s, e) => a.slice(s, e),
      _1642: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1643: a => a.length,
      _1645: (a, i) => a[i],
      _1646: (a, i, v) => a[i] = v,
      _1648: o => {
      ...
      _1649: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1651: o => o instanceof Uint8Array,
      _1652: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1653: o => o instanceof Int8Array,
      _1654: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1655: o => o instanceof Uint8ClampedArray,
      _1656: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1657: o => o instanceof Uint16Array,
      _1658: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1659: o => o instanceof Int16Array,
      _1660: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1661: o => o instanceof Uint32Array,
      _1662: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1663: o => o instanceof Int32Array,
      ...
      _1667: o => o instanceof Float32Array,
      _1668: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1669: o => o instanceof Float64Array,
      _1670: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1671: (t, s) => t.set(s),
      _1672: l => new DataView(new ArrayBuffer(l)),
      _1673: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1675: o => o.buffer,
      _1676: o => o.byteOffset,
      _1677: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1678: (b, o) => new DataView(b, o),
      _1679: (b, o, l) => new DataView(b, o, l),
      _1680: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1681: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1682: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1683: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1684: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1685: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1686: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1687: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1688: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1689: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1690: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1691: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1694: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1695: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1696: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1697: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1698: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1699: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1700: Function.prototype.call.bind(Number.prototype.toString),
      _1701: Function.prototype.call.bind(BigInt.prototype.toString),
      _1702: Function.prototype.call.bind(Number.prototype.toString),
      _1703: (d, digits) => d.toFixed(digits),
      _1715: () => globalThis.document,
      _1721: (x0,x1) => { x0.height = x1 },
      _1723: (x0,x1) => { x0.width = x1 },
      _1725: (x0,x1) => { x0.pointerEvents = x1 },
      _1734: x0 => x0.style,
      _1737: x0 => x0.src,
      _1738: (x0,x1) => { x0.src = x1 },
      _1739: x0 => x0.naturalWidth,
      _1740: x0 => x0.naturalHeight,
      _1756: x0 => x0.status,
      _1757: (x0,x1) => { x0.responseType = x1 },
      _1759: x0 => x0.response,
      _1836: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1837: (module,f) => finalizeWrapper(f, function() { return module.exports._1837(f,arguments.length) }),
      _2162: (x0,x1) => { x0.nonce = x1 },
      _2178: (x0,x1) => { x0.href = x1 },
      _3200: (x0,x1) => { x0.src = x1 },
      _3206: (x0,x1) => { x0.async = x1 },
      _3208: (x0,x1) => { x0.defer = x1 },
      _3668: () => globalThis.window,
      _3708: x0 => x0.document,
      _3711: x0 => x0.location,
      _3730: x0 => x0.navigator,
      _3992: x0 => x0.trustedTypes,
      _3994: x0 => x0.localStorage,
      _4002: x0 => x0.href,
      _4100: x0 => x0.geolocation,
      _4103: x0 => x0.mediaDevices,
      _4105: x0 => x0.permissions,
      _4119: x0 => x0.userAgent,
      _4170: x0 => x0.data,
      _4217: (x0,x1) => { x0.onmessage = x1 },
      _4324: x0 => x0.length,
      _4541: x0 => x0.readyState,
      _4554: (x0,x1) => { x0.binaryType = x1 },
      _4557: x0 => x0.code,
      _4558: x0 => x0.reason,
      _6266: x0 => x0.signal,
      _6275: x0 => x0.length,
      _6334: () => globalThis.document,
      _6415: x0 => x0.body,
      _6417: x0 => x0.head,
      _6746: (x0,x1) => { x0.id = x1 },
      _6769: x0 => x0.innerHTML,
      _6770: (x0,x1) => { x0.innerHTML = x1 },
      _8092: x0 => x0.value,
      _8094: x0 => x0.done,
      _8791: x0 => x0.url,
      _8793: x0 => x0.status,
      _8795: x0 => x0.statusText,
      _8796: x0 => x0.headers,
      _8797: x0 => x0.body,
      _9182: x0 => x0.state,
      _10495: x0 => x0.coords,
      _10496: x0 => x0.timestamp,
      _10498: x0 => x0.accuracy,
      _10499: x0 => x0.latitude,
      _10500: x0 => x0.longitude,
      _10501: x0 => x0.altitude,
      _10502: x0 => x0.altitudeAccuracy,
      _10503: x0 => x0.heading,
      _10504: x0 => x0.speed,
      _10505: x0 => x0.code,
      _10506: x0 => x0.message,
      _12414: x0 => x0.name,
      _13131: () => globalThis.console,
